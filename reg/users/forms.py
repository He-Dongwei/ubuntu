...
from .models import bill,accessrecord
...
class UserCreationForm(forms.ModelForm):#用户表单
    ...
    email2 = UsersEmailField(label=_('确认邮箱'),max_length=255)
